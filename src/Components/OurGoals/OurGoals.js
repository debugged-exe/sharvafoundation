    ...
    return(
        <div>
            ...
            <div data-aos='fade-up' className='w-100 ourButtons mt4 mb4 flex justify-center'>
            	<div style={hover1?{color: 'white', fontWeight: 'bold', border:'2px solid #e88f0a'}:{color: '#e88f0a', fontWeight: 'bold', border:'1.5px solid #e88f0a'}} onMouseEnter = {() => toggleHandler1()} onMouseLeave = {() => toggleHandler1()} className = "mh2 br2 mt2 mb4 ba btn ph4 pv3 pointer ">MAKE DONATION</div>
            	<div style={hover2?{color: 'white', fontWeight: 'bold', border:'2px solid #e88f0a'}:{color: '#e88f0a', fontWeight: 'bold', border:'1.5px solid #e88f0a'}} onMouseEnter = {() => toggleHandler2()} onMouseLeave = {() => toggleHandler2()} className = "mh2 br2 mt2 mb4 ba btn ph4 pv3 pointer ">BECOME A VOLUNTEER</div>
            </div>
        </div>
    )
}
