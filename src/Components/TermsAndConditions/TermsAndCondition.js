...
IMPORTANT INFORMATION REGARDING YOUR LEGAL RIGHTS AND REMEDIES.</h4>

                <div className={'center w-80 tl lh-copy'}><br/>
                    <h3>1.OverView</h3>
                    <p>This Terms of Service Agreement ("Agreement") is entered into by and between Sharva Foundation, registered
address HNO. 163 Ambika Vihar near PHC Gole Gujral Jammu, India ("Company") and you, and is made
effective as of the date of your use of this website http://sharvafoundation.org ("Site") or the date of electronic
acceptance.
</p>
                    <p>This Agreement sets forth the general terms and conditions of your use of the http://sharvafoundation.org as
...
<p>Company may, in its sole and absolute discretion, change or modify this Agreement, and any policies or
...
have been made shall constitute your acceptance of this Agreement as last revised.</p>

<h3>IF YOU DO NOT AGREE TO BE BOUND BY THIS AGREEMENT AS LAST REVISED, DO NOT USE
(OR CONTINUE TO USE) THIS SITE OR THE SERVICES.</h3>
                </div>
            </div>
            <div>
                ...
                <div className={'center w-80 tl lh-copy'}><br/>
                    <h3>2. ELIGIBILITY </h3>
                    <p>This Site and the Services are available only to Users who can form legally binding contracts under applicable
...
<p>By using this Site You acknowledge and agree that:</p><br/>
  <li>Your use of this Site, including any content you submit, will comply with this Agreement and all
applicable local, state, national and international laws, rules and regulations.</li><br/>
<p>You will not use this Site in a manner that:</p><br/>
...
<li>Promotes, encourages or engages in any spam or other unsolicited bulk email, or computer or network
hacking or cracking;
</li>
...
<li>Contains or installs any viruses, worms, bugs, Trojan horses, Cryptocurrency Miners or other code, files
or programs designed to, or capable of, using many resources, disrupting, damaging, or limiting the
functionality of any software or hardware.</li><br/>

<p>You will not:</p>
<li>copy or distribute in any medium any part of this Site, except where expressly authorized by Company,
</li>
<li>copy or duplicate this Terms of Services agreement, which was created with the help of the TermsHub.io
and the Terms of Use Generator ,
</li>
<li>modify or alter any part of this Site or any of its related technologies,
</li>
<li>access Companies Content (as defined below) or User Content through any technology or means other
...
marks and logos contained therein ("Companies Content"), are owned by or licensed to Sharva Foundation in
perpetuity, and are subject to copyright, trademark, and/or patent protection.
</p>

<p>Companies Content is provided to you "as is", "as available" and "with all faults" for your information and
...
<p>This Site may contain links to third-party websites that are not owned or controlled by Company. Company
...
conditions, privacy policies, and other governing documents of each other website that you may visit.</p><br/>

<h3>6. DISCLAIMER OF REPRESENTATIONS AND WARRANTIES</h3>

<p>YOU SPECIFICALLY ACKNOWLEDGE AND AGREE THAT YOUR USE OF THIS SITE SHALL BE AT
...
NO LIABILITY OR RESPONSIBILITY FOR THE SAME.</p>

<p>IN ADDITION, YOU SPECIFICALLY ACKNOWLEDGE AND AGREE THAT NO ORAL OR WRITTEN
...
<p>THE FOREGOING DISCLAIMER OF REPRESENTATIONS AND WARRANTIES SHALL APPLY TO
THE FULLEST EXTENT PERMITTED BY LAW, and shall survive any termination or expiration of this
Agreement or your use of this Site or the Services found at this Site.</p><br/>

<h3>7. LIMITATION OF LIABILITY</h3>
<p>IN NO EVENT SHALL COMPANY, ITS OFFICERS, DIRECTORS, EMPLOYEES, AGENTS, AND ALL
...
(IV) PERSONAL INJURY OR PROPERTY DAMAGE OF ANY NATURE WHATSOEVER, (V) THIRDPARTY CONDUCT OF ANY NATURE WHATSOEVER, (VI) ANY INTERRUPTION OR CESSATION OF
...
AND WHETHER OR NOT COMPANY IS ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.</p>

<p>IN ADDITION, You SPECIFICALLY ACKNOWLEDGE AND agree that any cause of action arising out of or
...
<p>THE FOREGOING LIMITATION OF LIABILITY SHALL APPLY TO THE FULLEST EXTENT
PERMITTED BY LAW, AND shall survive any termination or expiration of this Agreement or your use of this
Site or the Services found at this Site.</p><br/>
...
provision of this Agreement or the policies or agreements which are incorporated herein; and/or (iii) your
violation of any third-party right, including without limitation any intellectual property or other proprietary
...
<p>If you are visiting this Site from a country other than the country in which our servers are located, your
communications with us may result in the transfer of information across international boundaries. By visiting
this Site and communicating electronically with us, you consent to such transfers.</p><br/>

<h3>10. AVAILABILITY OF WEBSITE</h3>

<p>Subject to the terms and conditions of this Agreement and our policies, we shall use commercially reasonable
...
uninterrupted basis, and that we assume no liability to you or any other party with regard thereto.</p><br/>

<h3>11. DISCONTINUED SERVICES</h3>

<p>Company reserves the right to cease offering or providing any of the Services at any time, for any or no reason,
...
<p>You acknowledge and agree that your payment will be charged and processed by Sharva Foundation.</p>
<p>You agree to pay any and all prices and fees due for Services purchased or obtained at this Site at the time you
order the Services.
</p>
<p>Company expressly reserves the right to change or modify its prices and fees at any time, and such changes or
modifications shall be posted online at this Site and effective immediately without need for further notice to you.
</p>
<p>Except as expressly provided in these Terms, all charges and payments are non-refundable, non-cancellable, and
...
<p>Nothing in this Agreement shall be deemed to confer any third-party rights or benefits.</p><br/>

<h3>14. COMPLIANCE WITH LOCAL LAWS</h3>
<p>Company makes no representation or warranty that the content available on this Site are appropriate in every
...
formation shall be governed by and construed in accordance with the laws of India, Jammu and Kashmir, to the
exclusion of conflict of law rules.</p><br/>

<h3>16. DISPUTE RESOLUTION</h3>
<p>Any controversy or claim arising out of or relating to these Terms of Services will be settled by binding
...
conducted in India, Jammu and Kashmir, and judgment on the arbitration award may be entered into any court
having jurisdiction thereof.</p><br/>
...
utilized in any way to construe or interpret the agreement of the parties as otherwise set forth herein.</p><br/>
