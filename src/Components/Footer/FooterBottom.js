  ...
  return(
    ...
    <div className="ma2  ">
        <ul className="listStylingNone flex pointer">
          ...
          <li className="mh2"><a style={{outline:'none'}} href='https://www.facebook.com/Sharva-Foundation-571908020152850/' className='  white dimIcon'><FaFacebook className="fbhover" size="1.3rem" /></a></li>
