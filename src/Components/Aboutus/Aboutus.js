        ...
        <div className="aboutUs mb3" id="aboutus">
            ...
            <div className="cf abouttext ">
                ...
                <div className="fl  imgText text">
                  ...
                  In times such as these, it is of upmost importance that we need to work together. Any undocumented call of aid can turn out to be the decision that governs someone’s survival. By reaching us is how you prevent this.
                    </p>
